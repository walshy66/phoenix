...
import { getPlayHQConfig } from './lib/playhq-config.js';

const playHQConfig = getPlayHQConfig({ required: ['apiKey', 'tenant', 'clubName', 'seasonIds'] });
const PLAYHQ_API_KEY = playHQConfig.apiKey;
const TENANT = playHQConfig.tenant;
const CLUB_NAME = playHQConfig.clubMatch || playHQConfig.clubName;
const SEASON_IDS = playHQConfig.seasonIds;
const API_BASE = playHQConfig.apiBase;
