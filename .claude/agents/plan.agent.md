---
name: plan
description: Write a complete implementation plan with technical approach, phased delivery, testing strategy, and research documentation. Use this agent after design/analyze/clarify to create plan.md and supporting docs before breaking into tasks.
---
...
3. **Tasks Phase**: `claude-code-wrapper --agent tasks`
