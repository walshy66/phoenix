...
Example:
```bash
claude-code-wrapper --agent code-reviewer 054-exercise-block-tempo-persistence
```
...
Next steps:
  ...
  2. Re-run: claude-code-wrapper --agent code-reviewer {FEATURE-SLUG}
