---
name: analyze
description: Review a feature specification for gaps, contradictions, missing edge cases, and test coverage concerns. Use this agent after design to audit the spec for completeness before moving to planning. Returns findings but does NOT modify files - you decide what to fix.
---
...
```bash
claude-code-wrapper --agent analyze
```
...
**Or direct:**
```bash
claude-code-wrapper "Analyze feature 046 for gaps and edge cases"
```
...
- ✅ spec.md completed by design agent
...
3. Use clarify agent to propose changes, OR
...
3. **Fix Options**:
   - Option A: Use clarify agent to propose and apply changes
