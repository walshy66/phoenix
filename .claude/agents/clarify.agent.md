---
name: clarify
description: Review specification for improvements and propose changes before applying them. Use this agent after analyze to improve spec clarity, fix gaps, resolve contradictions, and ensure documents are tight before planning. Shows proposed changes for user approval before modifying files.
---
...
3. **Plan Phase**: `claude-code-wrapper --agent plan`
